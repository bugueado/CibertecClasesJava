...
public class Problema_2_3 extends JFrame implements ActionListener {
                ...
                try {
                    ...
                    try {
                        double precioDpto = leerPrecioDpto();
                         ...
                         Edificio e = new Edificio(123, 30, 20, 1200.50);
                         listado(e);

                         e.setPrecioDepartamentos(e.getPrecioDepartamentos() + (e.getPrecioDepartamentos()*0.20));
                         listado(e);
    ...
    void listado(Edificio x){
        imprimir("Dirmem: " + x);
        imprimir("codigo: " + x.getCodigo());
        imprimir("numero de departamentos: " + x.getNumeroDepartamentos());
        imprimir("cantidad de pisos: " + x.getCantidadPisos());
        imprimir("precio por departamento: " + x.getPrecioDepartamentos());
        imprimir("precio del edificio: " + x.precioEdificio());
        imprimir("");
    }
