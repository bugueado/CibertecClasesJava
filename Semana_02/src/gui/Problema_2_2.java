...
public class Problema_2_2 extends JFrame implements ActionListener {
    ...
    protected void actionPerformedBtnProcesar(ActionEvent arg0) {
        Computadora c = new Computadora(12234, "Apple", "White", 1350.50);
        listado(c);

        c.setPrecioDolares(c.getPrecioDolares() - (c.getPrecioDolares()*0.10));
        listado(c);
    }
    ...
    void listado(Computadora x){
        ...
        imprimir("precio en soles: " + x.precioSoles());
        imprimir("precio en euros: " + x.precioEuros());
        imprimir("");
    }
