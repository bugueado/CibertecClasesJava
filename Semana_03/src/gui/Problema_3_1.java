...
public class Problema_3_1 extends JFrame implements ActionListener {
    ...
    protected void actionPerformedBtnProcesar(ActionEvent arg0) {
        Factura a = new Factura("12345678901", "Corporacion ABC SAC", 100, 680.0);
        listado(a);

        Factura b = new Factura("98765432109", "Servicios XYZ SAA");
        listado(b);
        ...
        imprimir("Cantidad de facturas emitidas : " + Factura.getContador());
        imprimir("Suma de los impotes faturados : " + Factura.getAcumulador());
    }
