...
public class Problema_1_1 extends JFrame implements ActionListener {
    ...
    protected void actionPerformedBtnProcesar(ActionEvent arg0) {
        ...
        t.codigo = 12345;
        t.nombre = "Fernando Paredes";
        t.horasTrabajadas = 30;
        t.tarifaHoraria = 50.5;

        imprimir("Dirmem " + t);
        imprimir("codigo " + t.codigo);
        imprimir("nombre " + t.nombre);
        imprimir("Horas Trabajadas " + t.horasTrabajadas);
        imprimir("Tarifa " + t.tarifaHoraria);
        imprimir("Sueldo Bruto " + t.sueldoBruto());
        imprimir("Descuento " + t.descuento());
    }
