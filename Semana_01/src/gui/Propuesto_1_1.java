...
public class Propuesto_1_1 extends JFrame implements ActionListener {
    ...
    protected void actionPerformedBtnProcesar(ActionEvent arg0) {
        ...
        e.codigo = 1234;
        e.nombre = "Fernando Paredes Rios";
        e.horasTrabajadas = 30;
        e.tarifaHora = 20.5;

        imprimir("Dirmem: " + e);
        imprimir("codigo: " + e.codigo);
        imprimir("nombre: " + e.nombre);
        imprimir("Horas trabajadas: " + e.horasTrabajadas);
        imprimir("Tarifa Horas: " + e.tarifaHora);
        imprimir("sueldo bruto: " + e.sueldoBruto());
        imprimir("descuento afp: " + e.afp());
        imprimir("descuento eps: " + e.eps());
